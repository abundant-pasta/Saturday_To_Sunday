...
export default function AuthButton() {
  ...
  if (user) {
    return (
      <div className="flex items-center gap-3 bg-slate-900/50 pr-4 py-1 pl-1 rounded-full border border-slate-800">
        <div className="relative h-8 w-8 rounded-full overflow-hidden border border-slate-600">
  ...
  return (
    <button
      onClick={handleLogin}
      className="flex items-center gap-2 bg-white text-slate-900 px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest hover:bg-slate-200 transition-colors shadow-lg shadow-white/10"
    >
